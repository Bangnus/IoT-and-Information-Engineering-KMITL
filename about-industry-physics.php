...
<html lang="th" class="scroll-smooth">
  <head>
    ...
    <title>
      About Industry Physics - Department of IoT and Information Engineering
    </title>
    ...
    <main class="w-full py-16 min-h-[50vh]">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16">
          ...
          <div
            class="border border-orange-900/50 rounded-xl p-6 md:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.5)] bg-black/40 backdrop-blur-sm flex flex-col items-center"
          >
            <p
              class="text-sm md:text-base text-gray-300 leading-relaxed font-light mb-8 max-w-4xl text-left w-full"
            >
              หลักสูตรฟิสิกส์อุตสาหกรรมของ สอด. มุ่งพัฒนาความรู้ ทักษะ
              และเทคโนโลยีใหม่ๆ
              การฟิสิกส์และการนำศาสตร์ทางฟิสิกส์ไปประยุกต์ใช้ในงานอุตสาหกรรมด้านต่างๆ
              ตอบโจทย์ภาคเกษตรกรรมสมัยใหม่และอุตสาหกรรมเป็นหลักสูตรที่มีความยืดหยุ่นทางความคิดและศาสตร์เพื่อประยุกต์และประดิษฐ์นวัตกรรมใหม่ๆที่สามารถนำมาใช้ตอบสนองความต้องการอุตสาหกรรม
              ด้านต่างๆ เช่น วิศวกรรมวัสดุ ระบบเครือข่ายเซนเซอร์ต่างๆ
              ทางด้านการผลิตทางด้านการแพทย์ ด้านการเกษตร ฯลฯ
              สำหรับการวิเคราะห์ข้อมูล การออกแบบและพัฒนาอุปกรณ์ระบบไอโอที
              สำหรับวิจัย ประมวลผลและคาดการณ์ผล เป็นต้น
              <br /><br />
              เมื่อนักศึกษาเรียนปีที่ 2
              นักศึกษาสามารถเลือกเรียนรูปแบบปริญญาตรีควบหลักสูตรวิศวกรรมระบบไอโอทีและสารสนเทศและฟิสิกส์ของคณะวิศวกรรมศาสตร์
              สจล. เมื่อเรียนจบแล้วจะได้รับปริญญา วท.บ.ฟิสิกส์อุตสาหกรรม และ
              วศ.บ.วิศวกรรมระบบไอโอทีและสารสนเทศ
            </p>

            <!-- Center Image Placeholder (Replaced with specific image class if available) -->
            <div
              class="w-full max-w-2xl rounded-xl overflow-hidden shadow-lg border border-orange-900/30"
            >
              <img
        ...
        <div class="mb-16">
          ...
          >
            <!-- Left: Career List -->
            <div
              class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center border-b md:border-b-0 md:border-r border-orange-900/50"
            >
              <div class="flex items-center mb-6">
                <i class="fa-solid fa-award text-3xl text-orange-500 mr-4"></i>
              ...
              <ul
                class="text-sm md:text-base text-gray-300 space-y-2 list-disc pl-5"
              >
                <li>นัก STEM ศึกษา</li>
                <li>นักวิจัย</li>
                <li>วิศวกรผู้ประเมินราคา</li>
                <li>นักวิทยาศาสตร์/วิศวกรวัสดุ</li>
                <li>วิศวกรไฟฟ้า</li>
                <li>นักวิทยาการจัดการด้านข้อมูล</li>
                <li>วิศวกรด้านแสง</li>
                <li>วิศวกรวิเคราะห์ความน่าเชื่อถือและความล้มเหลว</li>
                <li>วิศวกรกระบวนการ</li>
                <li>ผู้ประกอบการทางธุรกิจเทคโนโลยี</li>
                <li>วิศวกรควบคุมคุณภาพ</li>
                <li>วิศวกรวิเคราะห์ความน่าเชื่อถือและการทดสอบ</li>
              </ul>
            </div>

            <!-- Right: Image -->
            <div class="w-full md:w-1/2 relative bg-gray-900">
              <img
                src="assets/images/image15.png"
                alt="IoT Technology Concept"
        ...
        <div class="mb-16">
          ...
          >
            <div
              class="space-y-4 text-xs md:text-sm text-gray-300 leading-relaxed font-light text-center"
            >
              <p>
