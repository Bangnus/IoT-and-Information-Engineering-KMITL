...
<head>
  ...
  <title>About Us - Department of IoT and Information Engineering</title>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-16">
        ...
        <div
          ...
          <div class="space-y-4 text-center text-sm md:text-base text-gray-300 leading-relaxed font-light">
            <p>
              ในยุคอุตสาหกรรม 4.0 เทคโนโลยีต่างๆ
              เข้ามามีบทบาทสำคัญเป็นอย่างมากในชีวิตประจำวันรวมถึงการพัฒนาเศรษฐกิจระดับประเทศ
              ที่การเชื่อมต่อสื่อสารนั้นเป็นไปอย่างรวดเร็ว
              ไม่เพียงแค่การสื่อสารระหว่างมนุษย์อย่างเดียว
              แต่ยังมีการเชื่อมต่อสื่อสารระหว่างอุปกรณ์กับอุปกรณ์ เครื่องจักร
              หรือทุกสรรพสิ่ง
              จึงเป็นที่มาของเทคโนโลยีระบบอินเทอร์เน็ตในทุกสรรพสิ่ง
              หรือเรียกสั้นๆว่าไอโอที (IoT) ซึ่งประกอบดัวยเทคโนโลยี ด้านสมาร์ท
              เซ็นเซอร์ การสื่อสารและเครือข่าย คอมพิวเตอร์และการพัฒนาซอฟต์แวร์
              วิทยาการข้อมูลและปัญญาประดิษฐ์
              ซึ่งเป็นการบูรณาการความรู้ในหลากหลายด้านเพื่อเรียกรวมว่า
              วิทยาการเพื่อให้สามารถออกแบบสร้างนวัตกรรม
              กรรมด้านระบบไอโอทีและสารสนเทศได้
            </p>
            <p>
              หลักสูตรวิศวกรรมระบบไอโอทีและสารสนเทศ
              เป็นหลักสูตรที่ตอบสนองต่อนโยบายการพัฒนาเศรษฐกิจ
              และอุตสาหกรรมของรัฐบาล
              โดยมีความสอดคล้องกับแผนพัฒนาเศรษฐกิจและสังคมแห่งชาติ ฉบับที่ 13
              (พ.ศ. 2565-2569)
              ที่ได้รับการกล่าวถึงการเปลี่ยนแปลงทางเทคโนโลยีแบบก้าวกระโดด
              (Disruption) และหนึ่งในเทคโนโลยีที่สำคัญนั้นคือ
              เทคโนโลยีระบบไอโอทีและสารสนเทศ เช่นเดียวกันกับอุตสาหกรรม
              เป้าหมายของประเทศ หรือที่เรียกว่า "S-Curve"
              ที่มีอุตสาหกรรมอิเล็กทรอนิกส์อัจฉริยะ และอุตสาหกรรมดิจิทัล (New
              S-Curve) รวมถึงการพัฒนาเขตเศรษฐกิจพิเศษภาคตะวันออก (EEC)
              ที่ภาครัฐจะสนับสนุน และมีความต้องการบัณฑิตในสาขานี้จำนวนมาก
            </p>
            <p>
              หลักสูตรวิศวกรรมระบบไอโอทีและสารสนเทศเป็นเสมือนฟันเฟืองที่เชื่อมองค์ประกอบของโลกดิจิทัลเข้าด้วยกัน
              ทั้งการรับ ส่งข้อมูล การประมวลผล การจัดเก็บและ
              ปฏิบัติเกี่ยวกับด้านเทคโนโลยีระบบไอโอทีและสารสนเทศโดยอาศัย
              ความรู้พื้นฐาน ทั้งด้านซอฟต์แวร์ ประกอบด้วย
              การเขียนโปรแกรมคอมพิวเตอร์ การพัฒนาซอฟต์แวร์และ แอพพลิเคชัน
              ด้านฮาร์ดแวร์ได้แก่
              การพัฒนาอุปกรณ์อิเล็กทรอนิกส์อัจฉริยะและสมาร์ทเซ็นเซอร์
              รวมทั้งเชื่อมโยงสื่อสารเข้าหากันด้วย
              การศึกษาด้านการสื่อสารและเครือข่าย
              ไปจนถึงการประยุกต์ใช้เทคโนโลยีปัญญาประดิษฐ์และวิทยาการข้อมูล
              โดยผสมผสานความรู้ต่างๆ เหล่านี้เข้ากับกระบวนการทางวิศวกรรมศาสตร์
              คณิตศาสตร์ เพื่อออกแบบสร้างนวัตกรรมใหม่ๆ
              และส่งเสริมให้นักศึกษาคิดต่อยอดนวัตกรรมของตนเอง
              เพื่อผลิตบัณฑิตให้เป็นสตาร์ทอัพเพื่อสร้างธุรกิจของตนเองได้
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mb-16">
        <div
          ...
          <div class="w-full md:w-1/2 p-4">
            <img src="assets/images/image13.png" alt="Students learning"
          ...
          <div class="w-full md:w-1/2 p-8 flex flex-col justify-center items-center">
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-2 list-disc pl-5">
              ...
              <li>นักพัฒนาส่วนระบบหลัง (Back End Developer)</li>
              ...
              <li>
                นักวิจัย นักวิชาการ ด้านเทคโนโลยีระบบไอโอทีและสารสนเทศ<br />ทั้งในระดับการทํางานของรัฐและจิรวิจัยได้
              </li>
            </ul>
          </div>
        </div>
