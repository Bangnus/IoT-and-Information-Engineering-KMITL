      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16">
          ...
          >
            <!-- Top Banner Label -->
            <div
              class="bg-orange-gradient py-4 px-6 md:px-6 rounded-lg mb-8 shadow-lg"
            >
            ...
            >
              ...
              >
                ...
                <p
                  class="text-sm text-gray-400 leading-relaxed font-light text-balance px-4"
                >
              ...
              >
                ...
                <p
                  class="text-sm text-gray-400 leading-loose font-light text-balance px-2"
                >
        ...
        <div class="mb-16">
          ...
          >
            ...
            <ul
              class="text-sm md:text-base text-gray-300 space-y-3 list-disc pl-5 max-w-xl w-full text-left"
            >
